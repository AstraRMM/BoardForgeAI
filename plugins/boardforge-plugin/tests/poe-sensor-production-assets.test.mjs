...
test('W5500 and BME280 registry pins preserve manufacturer numbering',()=>{const w=approvedAssetFor('W5500'),b=approvedAssetFor('BME280');assert.deepEqual(Object.fromEntries(['1','2','5','6','30','31','32','33','34','35','36','37'].map(k=>[k,w.pinMap[k]])),{'1':'ETH_TXN','2':'ETH_TXP','5':'ETH_RXN','6':'ETH_RXP','30':'XTAL_IN','31':'XTAL_OUT','32':'ETH_CS_N','33':'SPI_SCLK','34':'SPI_MISO','35':'SPI_MOSI','36':'ETH_INT_N','37':'ETH_RESET_N'});assert.deepEqual(b.pinMap,{1:'GND',2:'CSB',3:'SDI_SDA',4:'SCK_SCL',5:'SDO_ADDR',6:'VDDIO',7:'GND',8:'VDD'})})

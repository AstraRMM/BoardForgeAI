...
export const ethernetControllerProductionProposal=Object.freeze({
  ...
  bom:[
    ...
    approved('R_MODE0','10 kOhm W5500 PMODE0 strap','RC0603FR-0710KL'),
    approved('R_MODE1','10 kOhm W5500 PMODE1 strap','RC0603FR-0710KL'),
    approved('R_MODE2','10 kOhm W5500 PMODE2 strap','RC0603FR-0710KL'),
    approved('R_EXRES','12.4 kOhm 1% W5500 EXRES1 bias','RC0603FR-0712K4L'),
    ...['R_TXP','R_TXN','R_RXP','R_RXN'].map(ref=>approved(ref,'49.9 Ohm 1% 100BASE-TX line termination','RC0603FR-0749R9L')),
    ...
    approved('D_ETH','Four-channel 0.5 pF Ethernet cable-line ESD protector','TPD4E05U06DQAR'),
    approved('FB_AVDD','600 Ohm at 100 MHz 1 A analog-supply ferrite bead','MPZ1608S601ATA00'),
    approved('C_AVDD','4.7 uF analog-supply bulk capacitor','GRM188R60J475KE19D'),
    approved('C_TOCAP','4.7 uF W5500 TOCAP stabilizing capacitor','GRM188R60J475KE19D'),
    approved('C_1V2','10 nF W5500 1V2O stabilizing capacitor','GRM188R71H103KA01D'),
  ],
  supportDesign:{reset:{pullupOhm:10000,capacitanceF:100e-9,timeConstantS:1e-3,source:'W5500 EVB reference schematic'},pmode:{resistanceOhm:10000,pins:[43,44,45],startupState:'freeze in board schematic before evidence acceptance'},exres:{resistanceOhm:12400,tolerancePercent:1},lineTermination:{resistanceOhm:49.9,tolerancePercent:1,count:4},crystalLoad:{crystalLoadPf:8,assumedTotalParasiticPf:2,capacitorEachPf:12,calculation:'CL=(C1*C2)/(C1+C2)+Cstray; equal 12 pF capacitors plus 2 pF parasitic gives 8 pF'},esd:{mpn:'TPD4E05U06DQAR',channelCapacitancePf:0.5,iec61000_4_2ContactKv:12,dischargeReference:'CHASSIS'},analogSupply:{ferriteOhmAt100MHz:600,ratedCurrentA:1,bulkUf:4.7}},

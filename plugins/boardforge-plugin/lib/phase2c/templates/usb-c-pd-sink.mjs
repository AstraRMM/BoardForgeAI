...
export const usbCPdSinkTemplate=Object.freeze({
 ...
 mandatoryCircuits:['CC1/CC2 PD negotiation','9V/2A fixed sink PDO with 5V fallback','normally-off protected VBUS switch','input fuse and 24V TVS','28V-rated adjustable 5V/2A buck conversion with 73.2k/10k feedback divider','input/output polarized bulk decoupling','thermal copper and current-rated power path'],
 sourcing:{requiredProviders:['digikey','mouser'],runtimeStatus:'LIVE_VERIFIED',verifiedAt:'2026-07-15T23:18:00Z',exactDualProviderCoverage:'12/12',liveClaim:true},

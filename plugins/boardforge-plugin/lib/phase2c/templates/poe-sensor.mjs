...
export const poeSensorProductionProposal=Object.freeze({
  ...
  candidates:[
    {role:'ETHERNET_MAC_PHY_CONTROLLER',exactMpn:'W5500',status:'BLOCKED_PENDING_EXACT_ORDERING_CODE_PACKAGE_SYMBOL_FOOTPRINT_PIN_MAP_AND_LIFECYCLE'},
    {role:'POE_PD_AND_ISOLATED_CONVERTER',exactMpn:'Ag9900M',status:'BLOCKED_PENDING_EXACT_VARIANT_LAND_PATTERN_CLASSIFICATION_INPUT_OUTPUT_THERMAL_AND_ISOLATION_CERTIFICATE'},
    ...
    {role:'ENVIRONMENTAL_SENSOR',exactMpn:'BME280',status:'BLOCKED_PENDING_EXACT_ORDERING_CODE_PACKAGE_FOOTPRINT_PIN_MAP_AND_EXPOSURE_ANALYSIS'},
    {role:'POE_MAGJACK',exactMpn:null,status:'BLOCKED_NO_AUTHORITATIVE_EXACT_MAGJACK_PINOUT_LAND_PATTERN_CENTER_TAPS_POE_PAIRS_AND_SHIELD_BINDING'},
    {role:'ETHERNET_REFERENCE_CRYSTAL',exactMpn:null,status:'BLOCKED_PENDING_W5500_LOAD_CAPACITANCE_ESR_TOLERANCE_PACKAGE_AND_STARTUP_BUDGET'},
  ],

...
export const usbHubProductionProposal=Object.freeze({
  ...
  bom:[
    ...
    approved('U_DFP','four independent Type-C DFP controllers with integrated current-limited power switches and fault reporting','TPS25810RVCR',4),
    approved('R_RESET','10 kOhm hub reset pull-up','RC0603FR-0710KL'),approved('C_RESET','1 uF hub reset capacitor','GRM188R61A105KA61D'),
    approved('R_RBIAS','12 kOhm 1% hub RBIAS resistor','RC0603FR-0712KL'),
    approved('R_CFG0','100 kOhm CFG_SEL0 pull-down enabling strap mode','RC0603FR-07100KL'),approved('R_CFG1','100 kOhm CFG_SEL1 pull-down selecting self-powered individual switching','RC0603FR-07100KL'),approved('R_NONREM0','100 kOhm removable-port strap pull-down','RC0603FR-07100KL'),approved('R_NONREM1','100 kOhm removable-port strap pull-down','RC0603FR-07100KL'),
    approved('R_CC_UP','two upstream USB-C UFP 5.1 kOhm Rd resistors','RC0603FR-075K1L',2),
  ...
  supportDesign:{configuration:{cfgSel:[0,0],meaning:'Strap options, self-powered, individual power switching and overcurrent sensing',nonRem:[0,0],portPolicy:'all four downstream ports removable'},clock:{frequencyMHz:24,tolerancePpm:350,mpn:'Q22FA2380119417',loadCapacitancePf:18,loadNetwork:'blocked pending measured PCB stray-capacitance budget'},reset:{pullupOhm:10000,capacitanceUf:1},rbias:{ohm:12000,tolerancePercent:1},upstreamTypeC:{role:'UFP',rdOhm:5100,vbusPolicy:'detect only; no upstream-to-downstream VBUS backfeed'},downstreamTypeC:{role:'DFP',controller:'TPS25810RVCR',count:4,advertisement:'USB default',integratedFault:true,integratedPowerSwitch:true}},

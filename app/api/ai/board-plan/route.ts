...
const generationRequestSchema = z.object({
  ...
  boardType: z.string().default('custom_board'),
  boardShape: z.string().default('rounded_rectangle'),
  boardWidthMm: z.number().default(60),
  boardHeightMm: z.number().default(40),
  mountingHoleCount: z.number().default(4),
  layerCount: z.number().default(4),
  targetCad: z.string().default('KiCad'),
  manufacturer: z.string().default('JLCPCB'),
  assemblyTarget: z.string().default('not_verified'),
  ...
  placementMarks: z.array(z.record(z.string(), z.unknown())).default([]),

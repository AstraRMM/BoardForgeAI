export function ManufacturingRiskPanel() {
  return (
    <section className="rounded-lg border border-amber-500/30 bg-amber-500/10 p-4">
      ...
      <p className="mt-3 rounded bg-slate-950/40 px-2 py-1 text-xs text-amber-100">Assembly stays blocked until live supplier credentials are configured and verified.</p>
    </section>
  )
}

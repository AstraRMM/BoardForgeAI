...
export function ProjectActionPanel() {
  return (
    <section className="rounded-lg border border-slate-800 bg-slate-900 p-4">
      ...
      <p className="mt-2 text-sm text-slate-400">These actions start local engine jobs and poll status through localhost. Publish requires explicit confirmation.</p>

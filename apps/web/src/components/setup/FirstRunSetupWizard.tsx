...
const checks = [
  ['Local engine', 'OK', 'Start the installed BoardForge desktop helper before modifying KiCad files.'],
  ...
  ['Supplier API keys', 'Optional', 'Missing keys keep sourcing clearly marked as unavailable.'],
]

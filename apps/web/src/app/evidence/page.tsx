  ...
  return (
    <main className="bf-app-page">
      <section className="bf-app-hero">
        ...
        <p>Proof cards for engineers and founders: browser workflow checks, sourcing, source protection, approved-only publish, fixtures, reports, and known limitations.</p>
        <div className="bf-app-status-note">
          <strong>Evidence truth</strong>

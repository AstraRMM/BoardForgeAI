...
if pcbnew:
    class BoardForgeActionPlugin(pcbnew.ActionPlugin):
        ...
        def Run(self):
            ...
            pcbnew.wxLogMessage("Local Engine Service: http://127.0.0.1:38991")
            pcbnew.wxLogMessage("Health check: npm run boardforge:local-health")
            pcbnew.wxLogMessage("Start service if offline: npm run boardforge:local-server")
